...
object Http4sPlugin extends AutoPlugin {
  ...
  lazy val fs2Cats                          = Def.setting("co.fs2"                 %%% "fs2-cats"                  % "0.3.0")
  lazy val fs2Io                            = Def.setting("co.fs2"                 %%% "fs2-io"                    % "0.9.5")
  ...
  lazy val scodecBits                       = Def.setting("org.scodec"             %%% "scodec-bits"               % "1.1.4")
