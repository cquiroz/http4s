...
package object testing {
  ...
  val `audio/x-aiff`: MediaType = new MediaType("audio", "x-aiff", MimeDB.Compressible, MimeDB.Binary, List("aif", "aiff", "aifc"))
  ...
  val `audio/mp4`: MediaType = new MediaType("audio", "mp4", MimeDB.Uncompressible, MimeDB.Binary, List("m4a", "mp4a"))
